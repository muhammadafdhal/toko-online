...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/dist/polished.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/dist/iconic/css/open-iconicbootstrap.min.css')}}">
    <style>
        .grid-highlight {
            padding-top: 1rem;
            padding-bottom: 1rem;
                ...
                <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                    ...
                    <li>
                        <a href="{{route('books.index')}}">
                            <span class="oi oi-tag"></span> Manage books
                        </a>
                    </li>
